...
public class yellow : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        name = names[Rnd.Range(0, names.Length)];
        ...
        DisplayText.text = string.Concat(name,".",aa);
        ...
        Debug.LogFormat("[Yellow Button't #{0}] Binay:{1}", _moduleId,string.Concat(b1.ToString(), b2.ToString(), b3.ToString(), b4.ToString(), b5.ToString(), b6.ToString(), b7.ToString(), b8.ToString()));
    }
